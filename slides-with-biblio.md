...
- **Pressure ($P$):** $p = 0.8901$ (Not Significant)
- **Temperature ($T$):** $p = 0.4509$ (Not Significant)
- **Interaction ($P \times T$):** $p = 0.0243$ (**Significant**)

The analysis confirms that the effect of Pressure on Part Resistance is dependent on the Temperature level.
:::

::: {.column width="50%"}
<iframe data-src='media/plots/m1_interaction_claude.html' width='100%' height='500px' style='border:none;'></iframe>
:::
::::
